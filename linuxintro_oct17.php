...
<h3>Task 1 (under construction - shell scripting skills: basic and intermediate shell scripting exercises):</h3>
...
<p>1. Try adding new colour coordinations of text and foreground to the program - you can view a list of extra colour codes in the following text file <a href="http://www.macs.hw.ac.uk/~ls68/colour_codes.txt"> here</a>.</p>
...
<br>
<br>
<p>Click <a href="http://www.macs.hw.ac.uk/~ls68/snow.sh"> here</a> to download the source code we will be using for task 3.</p>
